package com.dev.flutter_twilio.receivers

import android.content.BroadcastReceiver
import android.content.Context
import android.content.Intent
import android.util.Log
import com.dev.flutter_twilio.FlutterTwilioPlugin

/**
 * Broadcast receiver provides communication from [TVConnectionService] to [FlutterTwilioPlugin]
 */
class TVBroadcastReceiver(private val plugin: FlutterTwilioPlugin) : BroadcastReceiver() {
    private val TAG = "TVBroadcastReceiver"

    companion object {
        /**
         * Action used to notify the [FlutterTwilioPlugin] of a change in audio state.
         */
        const val ACTION_AUDIO_STATE: String = "com.twilio.ACTION_AUDIO_STATE"

        /**
         * Action used to notify the [FlutterTwilioPlugin] of a change in the active call state.
         */
        const val ACTION_ACTIVE_CALL_CHANGED: String = "com.twilio.ACTION_ACTIVE_CALL_CHANGED"

        /**
         * Action used to notify the [FlutterTwilioPlugin] of an incoming call.
         */
        const val ACTION_INCOMING_CALL: String = "com.twilio.ACTION_INCOMING_CALL"

        /**
         * Action used to notify the [FlutterTwilioPlugin] when an incoming call invite is cancelled.
         */
        const val ACTION_INCOMING_CALL_CANCELLED: String = "com.twilio.ACTION_INCOMING_CALL_CANCELLED"
        ...
        /**
         * Action used to notify the [FlutterTwilioPlugin] of a call ended.
         */
        const val ACTION_CALL_ENDED: String = "com.twilio.ACTION_CALL_ENDED"

        /**
         * Action used to notify the [FlutterTwilioPlugin] for any call state changes, includes hold, unhold, mute, unmute.
         */
